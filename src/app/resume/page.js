  ...
  const contactItems = [
    {
      icon: FaPhone,
      text: "+92 3226409363",
      action: () => copyToClipboard("+92 3226409363"),
    },
    {
      icon: FaEnvelope,
      text: "mirzazan3334@gmail.com",
      action: () =>
        window.open(
          "https://mail.google.com/mail/?view=cm&fs=1&to=mirzazan3334@gmail.com",
          "_blank"
        ),
    },
    {
      icon: FaGithub,
      text: "github.com/mzain4321",
      action: () => window.open("https://github.com/mzain4321", "_blank"),
    },
  ...
  const experiences = [
    {
      ...
      description:
        "Web Development: Working as a Web Developer utilizing React and Laravel, collaborating with the team to build and maintain various web projects.",
    ...
    },
    {
      ...
      dateIcon: FaCalendarAlt,
      description:
        "TrustBridge AI: Developing a web application using React and Node.js that facilitates collaboration and investment between entrepreneurs and investors. The platform also enables supporters to contribute to cause campaigns.",
      projectIcon: FaBriefcase,
    },
    {
      ...
      dateIcon: FaCalendarAlt,
      description:
        "Gujrat Fans (Deployed): As a freelance developer, I built a single-page e-commerce platform for Gujrat Fans using Next.js, designed to showcase products and info about organization. The application is deployed on Vercel for performance and scalability.",
    ...
    },
    {
      ...
      dateIcon: FaCalendarAlt,
      description:
        "Event Management Web Application: Developed a platform for creating and managing local events using Next.js and MongoDB. Included features like event listings, booking system, and an admin control panel for event organizers.",
  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Full-Stack Web Developer specializing in Next.js, MongoDB, and MERN Stack"
        />
          ...
          >
            ...
            <div className="bg-gradient-to-r from-gray-800 to-gray-700 text-white p-6 md:p-10 text-center relative overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <p className="text-lg md:text-xl opacity-90 mb-6">
                  Full-Stack Web Developer | Next.js, MongoDB, MERN Stack
                  Enthusiast
                </p>
                // Update the contactItems rendering in your JSX
                <div className="flex flex-wrap justify-center gap-4 md:gap-8">
                  {contactItems.map((item, index) => (
                    ...
                    >
                      <item.icon />
                      <span className={index === 3 ? "inline" : "md:inline"}>
                        {item.text}
                      </span>{" "}
                      {/* Show always for location */}
                      <span
                        className={`${index === 3 ? "hidden" : "md:hidden"}`}
                      >
                        {index === 0
                          ? "Phone"
                          : index === 1
            ...
            <div className="p-5 md:p-10">
              ...
              <section className="mb-8 md:mb-10">
                <h2
                  className={`text-2xl md:text-3xl font-semibold mb-4 md:mb-5 pb-2 md:pb-3 border-b-4 border-indigo-500 flex items-center gap-3 ${
                ...
                <div
                  className={`text-base md:text-lg leading-relaxed p-4 md:p-6 rounded-2xl border-l-4 border-indigo-500 ${
                    isDarkTheme
                      ? "bg-gradient-to-r from-gray-700 to-gray-800 text-gray-200"
                      : "bg-gradient-to-r from-gray-50 to-gray-100 text-gray-600"
                  }`}
                >
                  Full-Stack Web Developer with practical experience in creating
                  modern web applications using Next.js, MongoDB, and Vercel,
                  enabling efficient server-side rendering and smooth
                  deployment. Actively expanding skills by working on projects
                  with the MERN stack (MongoDB, Express.js, React.js, Node.js)
                  to deepen expertise in full-stack development. Knowledgeable
                  in building RESTful APIs, working with MySQL databases,
                  deploying applications using Vercel, and integrating SaaS
                  tools. Committed to writing clean, maintainable code and
                  contributing to open-source projects to develop scalable and
                  ...
                  {experiences.map((exp, index) => (
                    <div
                      ...
                      className={`p-4 md:p-6 rounded-2xl shadow-lg ${
                        ...
                        !isMobile ? "hover:border-indigo-500" : ""
                      } cursor-pointer ${
                    ...
                    >
                      ...
                      <div
                        className={`text-xs md:text-sm mb-3 md:mb-4 flex items-center gap-2 ${
              ...
              <section className="mb-8 md:mb-10">
                ...
                >
                  ...
                  <div
                    className={`leading-relaxed text-sm md:text-base flex items-center gap-2 ${
                      isDarkTheme ? "text-gray-300" : "text-gray-600"
                    }`}
                  >
                    <FaLightbulb /> Gaining advanced knowledge in this field
                    while developing projects and gaining practical experience
              ...
              <section>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
                  {skillCategories.map((category, index) => (
                    ...
                    >
                      <h4
                        className={`font-semibold mb-3 md:mb-4 text-base md:text-lg flex items-center gap-2 ${
                          isDarkTheme ? "text-gray-100" : "text-gray-800"
                        }`}
                      >
                      ...
                      <div className="flex flex-wrap gap-2">
                        {category.skills.map((skill, skillIndex) => (
                          ...
                          >
                            <skill.icon className="text-xs md:text-base" />{" "}
